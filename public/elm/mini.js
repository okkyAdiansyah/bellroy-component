	...
	return _Utils_Tuple2(
		{
			...
			items: _List_fromArray(
				[
					{
					detail: {color: 'black', finish: 'black'},
					id: 1,
	...
	function (msg, model) {
		switch (msg.$) {
			...
			default:
				var id = msg.a;
				var qtyStr = msg.b;
				var _v1 = $elm$core$String$toInt(qtyStr);
				if (_v1.$ === 'Just') {
					var qty = _v1.a;
					var updatedItems = A2(
						$elm$core$List$map,
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(item.detail.color + (' / ' + item.detail.finish))
					])),
				A2(
				$elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text(
						'$' + $elm$core$String$fromFloat(item.price))
					])),
				A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						model.isOpen ? 'Close Cart' : 'Open Cart')
					])),
				model.isOpen ? A2(
				$elm$html$Html$div,
				_List_fromArray(
