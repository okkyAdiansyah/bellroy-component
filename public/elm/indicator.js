...
var $author$project$CartIndicator$init = function (flags) {
	return _Utils_Tuple2(
		{cartItem: flags.cartItem, mode: flags.mode},
		$elm$core$Platform$Cmd$none);
};
var $elm$json$Json$Decode$int = _Json_decodeInt;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$CartIndicator$UpdateModel = function (a) {
...
var $author$project$CartIndicator$main = $elm$browser$Browser$element(
	{init: $author$project$CartIndicator$init, subscriptions: $author$project$CartIndicator$subscriptions, update: $author$project$CartIndicator$update, view: $author$project$CartIndicator$view});
_Platform_export({'CartIndicator':{'init':$author$project$CartIndicator$main(
	A2(
			...
			return A2(
				...
				function (cartItem) {
					return $elm$json$Json$Decode$succeed(
						{cartItem: cartItem, mode: mode});
				},
				A2($elm$json$Json$Decode$field, 'cartItem', $elm$json$Json$Decode$int));
		},
		A2($elm$json$Json$Decode$field, 'mode', $elm$json$Json$Decode$string)))(0)}});}(this));